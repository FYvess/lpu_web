...
$conn = OpenCon();
$sql = "SELECT * FROM `íncometbl` JOINdeductiontbl ON income.employee_no = deductiontbl.employee_no JOIN personal_infotbl ON deduction.employee_no = incometbl.employee;";
...
<body>
    <div class="d-flex">
        <div class="vh-100 sticky-top bg-danger" style="width: 280px;">
            <h2 class="text-white fs-5 text-center my-5">Yves's Enterprise</h2>
            <nav class="NAVBAR">
                ...
                <section>
                    <div class="table-responsive">
                        <table class="table table-borderless bg-white rounded small table-hover">
                            <thead class="border">
                                <tr>
                                    <th class="py-6 ps-6 border bg-danger">
                            ...
                            <tbody>
                                ...
                                if ($result) {
                                    while ($item = $result->fetch_assoc()) {
                                        echo "
                                    <tr class='clickable-row' style='cursor: pointer' data-href='employee_registation_save.php?id={$item['id']}'>
                                        ...
                                        <td class='py-6 ps-6 border' style='border-color: black !important;'>$item[birth_date]</td>
                                        <td class='py-6 ps-6 border' style='border-color: black !important;'>$item[qualified_dependent_status]</td>
                                        <td class='py-6 ps-6 border' style='border-color: black !important;'>$item[civil_status]</td>
                                        <td class='py-6 ps-6 border' style='border-color: black !important;'>$item[department]</td>
                                        <td class='py-6 ps-6 border' style='border-color: black !important;'>$item[designation]</td>   
                                        <td class='py-6 ps-6 border' style='border-color: black !important;'>$item[employee_status]</td>
                                    </tr>
                                ";
                                }}
                                ?>
